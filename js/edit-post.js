...
const portfolioData = require(path.join(__dirname, 'portfolio/portfolio.json'));
...
if (indexToModify !== -1) {
  ...
  fs.writeFileSync(path.join(__dirname, 'portfolio/portfolio.json'), JSON.stringify(portfolioData, null, 2));
